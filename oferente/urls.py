...
from .views import comercios, estadisticas_oferente, verificarCuit, registrarComercio,ubicacion_comercio, lista_comercio, perfil_comercio
...
urlpatterns = [
    ...
    path('mis_estadisticas/', estadisticas_oferente, name='mis_estadisticas')
]
